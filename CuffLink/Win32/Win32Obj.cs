...
namespace Kohoutech.Win32
{
    ...
    public class Win32Obj : Win32Coff
    {
        ...
        public static void loadRelocations(SourceFile source, Section sec, Win32Obj objfile)
        {            
        ...
        public static Win32Obj readFromFile(String filename)
        {
            ...
            for (int i = 0; i < sectionCount; i++)
            {
                ...
                Section section = new Section(secname, settings);
            ...
            foreach (Section section in objfile.sections)
            {
                //load section data
